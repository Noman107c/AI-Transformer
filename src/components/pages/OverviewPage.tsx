  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-7 gap-4">
        {/* Healthy */}
        <div className="bg-slate-900 border-l-4 border-l-emerald-500 border border-slate-800 p-4.5 rounded-xl flex flex-col justify-between hover:border-r-emerald-500/30 transition duration-300 shadow-lg">
          <div className="text-xs font-bold uppercase tracking-wider text-slate-400">Healthy</div>
          <div className="flex items-baseline justify-between mt-3 gap-1">
            <span className="text-3xl font-extrabold font-sans text-emerald-400">{healthyCount}</span>
        ...
        {/* Moderate */}
        <div className="bg-slate-900 border-l-4 border-l-yellow-500 border border-slate-800 p-4.5 rounded-xl flex flex-col justify-between hover:border-r-yellow-500/30 transition duration-300 shadow-lg">
          <div className="text-xs font-bold uppercase tracking-wider text-slate-400">Moderate</div>
          <div className="flex items-baseline justify-between mt-3 gap-1">
            <span className="text-3xl font-extrabold font-sans text-yellow-400">{moderateCount}</span>
            <span className="text-xs font-mono text-yellow-500 bg-yellow-500/10 px-2 py-0.5 rounded font-bold">
        ...
        {/* At Risk */}
        <div className="bg-slate-900 border-l-4 border-l-orange-500 border border-slate-800 p-4.5 rounded-xl flex flex-col justify-between hover:border-r-orange-500/30 transition duration-300 shadow-lg">
          <div className="text-xs font-bold uppercase tracking-wider text-slate-400">At Risk</div>
          <div className="flex items-baseline justify-between mt-3 gap-1">
            <span className="text-3xl font-extrabold font-sans text-orange-400">{atRiskCount}</span>
            <span className="text-xs font-mono text-orange-400 bg-orange-500/10 px-2 py-0.5 rounded font-bold">
        ...
        {/* Critical */}
        <div className="bg-slate-900 border-l-4 border-l-red-500 border border-slate-800 p-4.5 rounded-xl flex flex-col justify-between hover:border-r-red-500/30 transition duration-300 shadow-lg">
          <div className="text-xs font-bold uppercase tracking-wider text-slate-400">Critical</div>
          <div className="flex items-baseline justify-between mt-3 gap-1">
            <span className="text-3xl font-extrabold font-sans text-red-400">{criticalCount}</span>
            <span className="text-xs font-mono text-red-500 bg-red-500/10 px-2 py-0.5 rounded font-bold">
        ...
        {/* Avg Health Score */}
        <div className="bg-slate-900 border-l-4 border-l-sky-500 border border-slate-800 p-4.5 rounded-xl flex flex-col justify-between hover:border-r-sky-500/30 transition duration-300 shadow-lg">
          <div className="text-xs font-bold uppercase tracking-wider text-slate-400">Avg. Health Index</div>
          <div className="mt-3 flex items-baseline justify-between gap-1">
            <span className="text-2xl font-extrabold text-white">{avgHealthIndex}</span>
            <span className="text-[10px] text-slate-500 font-mono">/100</span>
          </div>
        </div>

        {/* Total Outages */}
        <div className="bg-slate-900 border-l-4 border-l-blue-500 border border-slate-800 p-4.5 rounded-xl flex flex-col justify-between hover:border-r-blue-500/30 transition duration-300 shadow-lg">
          <div className="text-xs font-bold uppercase tracking-wider text-slate-400">Total Outages</div>
          <div className="mt-3 text-3xl font-extrabold text-white text-right">{totalOutages}</div>
        </div>

        {/* Total Maintenance */}
        <div className="bg-slate-900 border-l-4 border-l-fuchsia-500 border border-slate-800 p-4.5 rounded-xl flex flex-col justify-between hover:border-r-fuchsia-500/30 transition duration-300 shadow-lg">
          <div className="text-xs font-bold uppercase tracking-wider text-slate-400">Total Maintenance</div>
          <div className="mt-3 text-3xl font-extrabold text-white text-right">{totalMaintenance}</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 animate-fadeIn">
        ...
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl xl:col-span-5 flex flex-col shadow-xl">
            ...
            <table className="w-full text-left border-collapse text-xs">
              <thead>
                <tr className="border-b border-slate-800 text-slate-400 bg-slate-900/50">
                  ...
                  <th className="py-2.5 px-2">Health Status</th>
                  <th className="py-2.5 px-2">RUL (Days)</th>
                  <th className="py-2.5 px-2">Age (Years)</th>
                  <th className="py-2.5 px-2 text-right font-semibold">Overall Weightage</th>
                </tr>
              </thead>
              <tbody>
          ...
          <div className="flex items-center justify-between mt-4 text-[11px] text-slate-500 select-none">
            <span>Showing 1 to 10 of {totalTransformers} entries</span>
            <div className="flex gap-1.5 font-mono">
              <span className="px-2 py-0.5 rounded bg-blue-600 text-white font-bold cursor-pointer">1</span>
              <span className="px-2 py-0.5 rounded hover:bg-slate-800 cursor-pointer">2</span>
              <span className="px-2 py-0.5 rounded hover:bg-slate-800 cursor-pointer">3</span>
              <span className="px-2 py-0.5 rounded hover:bg-slate-800 cursor-pointer opacity-70">›</span>
              <span className="px-2 py-0.5 rounded hover:bg-slate-800 cursor-pointer opacity-70">»</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl xl:col-span-4 flex flex-col shadow-xl">
          ...
          <div className="flex flex-wrap gap-x-3 gap-y-1 justify-center mt-4 text-[10px] text-slate-400 font-mono">
        ...
        <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl xl:col-span-3 flex flex-col shadow-xl">
          ...
          <div className="relative flex-1 flex items-center justify-center min-h-[180px] my-1">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
                  data={weightageData}
          ...
          <div className="grid grid-cols-2 gap-y-1 gap-x-2 text-[10px] text-slate-400 px-1 mt-2">
            {weightageData.map(item => (
              <div key={item.name} className="flex items-center justify-between border-b border-slate-900 pb-1">
